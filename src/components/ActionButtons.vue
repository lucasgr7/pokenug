  ...
  <div class="flex flex-col space-y-4">
    ...
    <div class="relative group">
      <button @click="$emit('capture')" :disabled="!canCapture"
        class="relative w-16 h-16 bg-blue-500 text-white rounded-full hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 overflow-hidden select-none flex items-center justify-center border-4 border-blue-400 hover:scale-110 shadow-lg"
        :class="{
    ...
    <!-- Seeker Stone Button -->
    <div class="relative group">
      <button @click="$emit('seeker-stone')" v-if="canUseSeekerStone"
        class="relative w-16 h-16 bg-yellow-600 text-white rounded-full hover:bg-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 overflow-hidden select-none flex items-center justify-center border-4 border-yellow-500 hover:scale-110 shadow-lg"
        :class="{
